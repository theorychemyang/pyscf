...
class KnownValues(unittest.TestCase):
    def test_hess_H2O(self):
        ...
        self.assertAlmostEqual(results['freq_wavenumber'][-1], 3713.606, 1)
        self.assertAlmostEqual(results['freq_wavenumber'][-2], 3609.742, 1)
        self.assertAlmostEqual(results['freq_wavenumber'][-3], 1572.843, 1)
